...
#define CSVNAME "array_data_md2d.csv"
...
int main(int argc, char **argv)
{
    ...
    // -n : collect stats every _ iterations
    ...
    for (long step = 0; step < nsteps; ++step)
    {
        ...
        if (step % statsevery == (statsevery - 1))
        {
